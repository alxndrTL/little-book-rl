"""
Deep Q-Network (DQN) as described in the book.
...
- the first steps are collected without any update, to have a sufficiently diverse dataset at the start of training
- instead of doing one update every step, we do one every `train_frequency` steps
- decreasing epsilon
- Adam optimizer instead of gradient descent
- the buffer is capped in size (FIFO)
